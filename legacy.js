...
(function() {
  var ProgressReporter, Promise, Registry, RegistryV1, RegistryV2, _, calculatePercentage, getLongId, request,
  ...
  RegistryV1 = (function(superClass) {
    ...
    RegistryV1.prototype.getVersion = function() {
      return 1;
    };
  ...
  RegistryV2 = (function(superClass) {
    extend(RegistryV2, superClass);

    function RegistryV2() {
      return RegistryV2.__super__.constructor.apply(this, arguments);
    }

    RegistryV2.prototype.getVersion = function() {
      return 2;
    };
  ...
  exports.ProgressReporter = ProgressReporter = (function() {
    function ProgressReporter(renderProgress, docker) {
        ...
        return function(evt) {
          ...
          try {
            ...
            if (status === 'Downloading') {
              ...
              currentDownloadedSize[shortId] = 0;
              currentExtractedSize[shortId] = 0;
            } else if (status.match(/^Status: Image is up to date for /) || status.match(/^Status: Downloaded newer image for /)) {
      ...
      return this.getImageLayerSizes(image).then(function(layerSizes) {
        ...
        return function(evt) {
          ...
          try {
            ...
            if (status.match(/^latest: digest: /) || status.match(/^Pushing tag for rev /)) {
