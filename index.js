...
(function() {
  var DEFAULT_PROGRESS_BAR_STEP_COUNT, Docker, DockerProgress, LEGACY_DOCKER_VERSION, ProgressReporter, ProgressTracker, Promise, _, legacy, onProgressHandler, renderProgress, semver;
    ...
    ProgressReporter.prototype.pushProgress = Promise.method(function(image, onProgress) {
      ...
      return function(evt) {
        ...
        try {
          ...
          percentage = status.startsWith('latest: digest: ') || status.startsWith('Pushing tag for rev ') ? 100 : progressTracker.getProgress();
          percentage = lastPercentage = Math.max(percentage, lastPercentage);
          return onProgress(_.merge(evt, {
            id: id,
            percentage: percentage,
  ...
  exports.DockerProgress = DockerProgress = (function() {
    ...
    DockerProgress.prototype.pull = function(image, onProgress, callback, options) {
