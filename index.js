...
(function() {
  var Docker, DockerProgress, Promise, Registry, _, calculatePercentage, getLongId, getRegistryAndName, humanize, onProgressHandler, request;
  ...
  exports.DockerProgress = DockerProgress = (function() {
    ...
    DockerProgress.prototype.pullProgress = function(image, onProgress) {
      return this.getLayerDownloadSizes(image).then(function(layerSizes) {
        ...
        return function(evt) {
          var downloadedSize, err, error, longId, percentage, ref, shortId, status;
          try {
            status = evt.status;
            shortId = evt.id;
