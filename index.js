...
(function() {
  var Docker, DockerProgress, Promise, Registry, RegistryV1, RegistryV2, _, calculatePercentage, getLongId, getRegistryAndName, humanize, onProgressHandler, request,
  ...
  exports.DockerProgress = DockerProgress = (function() {
    ...
    DockerProgress.prototype.getLayerDownloadSizes = function(image) {
      return getRegistryAndName(image).then(function(arg) {
    ...
    DockerProgress.prototype.pullProgress = function(image, onProgress) {
      return this.getLayerDownloadSizes(image).spread(function(layerSizes, remoteLayerIds) {
        ...
        return function(evt) {
          var downloadedSize, err, error, percentage, ref, remoteId, shortId, status;
          try {
            status = evt.status;
            shortId = evt.id;
